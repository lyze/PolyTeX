...
(function (exports) {
  ...
  window.addEventListener('WebComponentsReady', function () {
    ...
    app.connectCloud = function () {
      drawerPanel.closeDrawer();
      if (app.fileId) {
        editor.startCloudIntegration().then(function (_) {
          apiErrorToast.close();
        });
      } else {
  ...
  var page = __commonjs(function (module, exports, global) {
  !function (e) {
  ...
  var page$1 = (page && typeof page === 'object' && 'default' in page ? page['default'] : page);
  ...
  window.addEventListener('WebComponentsReady', function () {
    ...
    if (window.location.port === '') {
      // if production
      page$1.base(app.baseUrl.replace(/\/$/, ''));
    }

    page$1(app.baseUrl, function () {
      app.route = 'editor';
    });
